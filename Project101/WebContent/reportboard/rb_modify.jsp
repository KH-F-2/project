...
<html>
	...
	<body>	
		<div class="header"><h1>신고게시판 수정</h1></div>
			...
			<ul class="write_ul">
				...
				<li class="write_li">
					<div class="title">
						...
						<input name="RB_TITLE" value="${boardBean.RB_TITLE}" type="text" size="50" maxlength="100" placeholder="제목을 입력하세요">
					</div>
				</li>
				...
				<li class="write_li">
					...
					<div class="price">
						...
						<input name = "RB_PRICE" value="${boardBean.RB_PRICE}" type="text" size="50" maxlength="50" placeholder="가격을 입력하세요">
					</div>
				</li>
				
				<li class="write_li">
					<div class="content">
						<textarea name="RB_CONTENT" cols="65" rows="15">${boardBean.RB_CONTENT}</textarea>
					</div>
				</li>
