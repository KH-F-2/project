			...
			<th colspan="2">신고 게시판 상세 페이지</th>
			 ...
			 <ul class="rbview_ul">
				...
				<li class="rbview_li 2">
					...
					<div class="writer">
						<a href="./sellerpage_main.me?writer=${boardbean.RB_WRITER}">${boardbean.RB_WRITER}</a>
						<input type="hidden" id="RB_WRITER" value="${boardbean.RB_WRITER}">
					</div>
					
					
					
					<div class="price">${boardbean.RB_PRICE } 원</div>
