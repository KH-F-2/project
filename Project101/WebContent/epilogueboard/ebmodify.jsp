...
<html>
	<head>
        ...
        <script src="/test/js/ebBoardBean.js"></script>
        <style>
	...
	<body>	
		<form action="./ebmodify.eb" method="post">
				<input type="hidden" name="SB_NO" value="${ebBoardBean.SB_NO}">
			<table>
				<tr>
				...
				<tr>
					<td>작성자</td>
					<td>
						${ebBoardBean.SB_WRITER}
					</td>
				</tr>
				<tr>
					<td>제목</td>
					<td><input name="SB_TITLE"  type="text" size="50" maxlength="100" value="${ebBoardBean.SB_TITLE}"></td>
				</tr>
				<tr>
					<td>가격</td>
					<td>
						<input name = "SB_PRICE" type="text" size="50" maxlength="100" value="${ebBoardBean.SB_PRICE}">
					</td>
				</tr>
				<tr>
					<td>구매날짜</td>
					<td>
						<input name = "SB_DATE" type="text" size="50" maxlength="100" value="${ebBoardBean.SB_DATE}">
					</td>
				</tr>
				<tr>
					<td>
					...
					<td>
						<textarea name="SB_CONTENT" id="board_content" cols="65" rows="15">${ebBoardBean.SB_CONTENT}</textarea>
					</td>
				</tr>
				<tr class="center">
