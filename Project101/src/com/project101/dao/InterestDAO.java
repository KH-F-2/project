...
public class InterestDAO {
	...
	public JSONArray getBoardlist(String id) {
		...
		try {
			...
			sb.append("select rownum rnum, NUM, content_num, WRITER, TITLE, content, price, READCOUNT, DDATE, category, hashtag, lat, lng, IMAGE_URL, BOARD_NAME, id from "
					+ "(select NUM, content_num, WRITER, TITLE, content, price, READCOUNT, DDATE, category, hashtag, lat, lng, IMAGE_URL, BOARD_NAME , id from "
					+ "(select SB_NO NUM, content_num, SB_WRITER WRITER, SB_TITLE TITLE, SB_CONTENT content, sb_price price, SB_READCOUNT READCOUNT, SB_DATE DDATE"
					...
					+ ", (select num in_num, content_num, id from interest where board_name='SELL_BOARD') where sb_no=content_num) "
					+ "UNION ALL "
					+ "(select PB_NO NUM, content_num, PB_WRITER WRITER, PB_TITLE TITLE, pb_content content, pb_price price, PB_READCOUNT READCOUNT, PB_DATE DDATE"
					...
					+ ", (select num in_num, content_num, id from interest where board_name='PURCHASE_BOARD') where pb_no=content_num)"
			...
			while (rset.next()) {
				...
				jsonObj.put("content_num", rset.getString("content_num"));
